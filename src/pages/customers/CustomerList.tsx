    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ getValue }) => (
          <Badge
            variant={
              (getValue() as string) === "wholesale" ? "info" : "default"
            }
          >
            {getValue() as string}
          </Badge>
      ...
      },
      {
        ...
        cell: ({ getValue }) => {
          ...
          return bal > 0 ? (
            ...
            <span className="font-mono text-sm text-txt-muted">
      ...
      },
      {
        ...
        cell: ({ getValue }) => {
          ...
          return pts > 0 ? (
            <Badge variant="info">{pts} pts</Badge>
          ) : (
  ...
  return (
    <div className="p-6 space-y-5">
        ...
        {loading ? (
          ...
          <div className="py-16">
            <EmptyState
              ...
              title={search ? "No results" : `No ${label.toLowerCase()}s yet`}
              action={
                !search ? (
                  <Button
                    size="sm"
      ...
      <ConfirmDialog
        ...
        title={`Delete ${label}`}
        message="This will soft-delete the customer."
        confirmText="Delete"
        variant="danger"
        loading={deleting}
      />
